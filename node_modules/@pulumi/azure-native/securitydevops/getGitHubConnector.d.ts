 ...
 */
export declare function getGitHubConnector(args: GetGitHubConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetGitHubConnectorResult>;
...
export interface GetGitHubConnectorResult {
     ...
     */
    readonly properties: outputs.securitydevops.GitHubConnectorPropertiesResponse;
    /**
 ...
 * Azure REST API version: 2022-09-01-preview.
 */
export declare function getGitHubConnectorOutput(args: GetGitHubConnectorOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetGitHubConnectorResult>;
