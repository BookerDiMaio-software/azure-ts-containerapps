 ...
 * Get a specific security operator for the requested scope.
 */
export declare function getSecurityOperatorOutput(args: GetSecurityOperatorOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSecurityOperatorResult>;
