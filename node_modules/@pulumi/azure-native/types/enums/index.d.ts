...
export { aad, aadiam, agfoodplatform, alertsmanagement, analysisservices, apicenter, apimanagement, app, appconfiguration, appplatform, attestation, authorization, automanage, automation, autonomousdevelopmentplatform, avs, azureactivedirectory, azurearcdata, azuredatatransfer, azureplaywrightservice, azuresphere, azurestack, azurestackhci, baremetalinfrastructure, batch, blockchain, blueprint, botservice, cache, cdn, certificateregistration, changeanalysis, chaos, cloudngfw, codesigning, cognitiveservices, communication, community, compute, confidentialledger, confluent, connectedvmwarevsphere, consumption, containerinstance, containerregistry, containerservice, containerstorage, costmanagement, customerinsights, customproviders, dashboard, databasewatcher, databox, databoxedge, databricks, datacatalog, datadog, datafactory, datalakeanalytics, datalakestore, datamigration, dataprotection, datareplication, datashare, dbformariadb, dbformysql, dbforpostgresql, delegatednetwork, desktopvirtualization, devcenter, devhub, deviceregistry, devices, deviceupdate, devopsinfrastructure, devspaces, devtestlab, digitaltwins, documentdb, domainregistration, edgeorder, education, elastic, elasticsan, enterpriseknowledgegraph, eventgrid, eventhub, extendedlocation, features, fluidrelay, guestconfiguration, hardwaresecuritymodules, hdinsight, healthbot, healthcareapis, hybridcloud, hybridcompute, hybridconnectivity, hybridcontainerservice, hybriddata, hybridnetwork, importexport, insights, iotcentral, iotfirmwaredefense, iotoperationsmq, iotoperationsorchestrator, keyvault, kubernetes, kubernetesconfiguration, kubernetesruntime, kusto, labservices, loadtestservice, logic, logz, m365securityandcompliance, machinelearning, machinelearningcompute, machinelearningservices, maintenance, managednetwork, managednetworkfabric, managedservices, maps, marketplace, media, migrate, mixedreality, mobilenetwork, mobilepacketcore, netapp, network, networkanalytics, networkcloud, networkfunction, notificationhubs, offazure, offazurespringboot, operationalinsights, orbital, peering, policyinsights, portal, powerbi, powerbidedicated, powerplatform, providerhub, purview, quantum, quota, recommendationsservice, recoveryservices, redhatopenshift, relay, resourceconnector, resources, saas, scheduler, scom, scvmm, search, security, securityandcompliance, securitydevops, securityinsights, serialconsole, servicebus, servicefabric, servicefabricmesh, servicelinker, servicenetworking, signalrservice, solutions, sql, sqlvirtualmachine, standbypool, storage, storageactions, storagecache, storagemover, storagepool, storagesync, storsimple, streamanalytics, subscription, synapse, testbase, timeseriesinsights, videoanalyzer, videoindexer, virtualmachineimages, visualstudio, vmwarecloudsimple, voiceservices, web, webpubsub, windowsesu, workloads, };
