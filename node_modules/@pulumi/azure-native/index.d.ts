...
export { aad, aadiam, addons, advisor, agfoodplatform, alertsmanagement, analysisservices, apicenter, apimanagement, app, appcomplianceautomation, appconfiguration, appplatform, attestation, authorization, automanage, automation, autonomousdevelopmentplatform, avs, azureactivedirectory, azurearcdata, azuredata, azuredatatransfer, azureplaywrightservice, azuresphere, azurestack, azurestackhci, baremetalinfrastructure, batch, billing, blockchain, blueprint, botservice, cache, cdn, certificateregistration, changeanalysis, chaos, cloudngfw, codesigning, cognitiveservices, communication, community, compute, confidentialledger, config, confluent, connectedvmwarevsphere, consumption, containerinstance, containerregistry, containerservice, containerstorage, costmanagement, customerinsights, customproviders, dashboard, databasewatcher, databox, databoxedge, databricks, datacatalog, datadog, datafactory, datalakeanalytics, datalakestore, datamigration, dataprotection, datareplication, datashare, dbformariadb, dbformysql, dbforpostgresql, delegatednetwork, desktopvirtualization, devcenter, devhub, deviceregistry, devices, deviceupdate, devopsinfrastructure, devspaces, devtestlab, digitaltwins, documentdb, domainregistration, dynamics365fraudprotection, easm, edgemarketplace, edgeorder, education, elastic, elasticsan, engagementfabric, enterpriseknowledgegraph, eventgrid, eventhub, extendedlocation, features, fluidrelay, graphservices, guestconfiguration, hardwaresecuritymodules, hdinsight, healthbot, healthcareapis, hybridcloud, hybridcompute, hybridconnectivity, hybridcontainerservice, hybriddata, hybridnetwork, importexport, insights, integrationspaces, intune, iotcentral, iotfirmwaredefense, iotoperationsdataprocessor, iotoperationsmq, iotoperationsorchestrator, keyvault, kubernetes, kubernetesconfiguration, kubernetesruntime, kusto, labservices, loadtestservice, logic, logz, m365securityandcompliance, machinelearning, machinelearningcompute, machinelearningexperimentation, machinelearningservices, maintenance, managedidentity, managednetwork, managednetworkfabric, managedservices, management, managementpartner, maps, marketplace, media, migrate, mixedreality, mobilenetwork, mobilepacketcore, monitor, netapp, network, networkanalytics, networkcloud, networkfunction, notificationhubs, offazure, offazurespringboot, openenergyplatform, operationalinsights, operationsmanagement, orbital, peering, policyinsights, portal, powerbi, powerbidedicated, powerplatform, professionalservice, providerhub, purview, quantum, quota, recommendationsservice, recoveryservices, redhatopenshift, relay, resourceconnector, resourcegraph, resourcehealth, resources, saas, scheduler, scom, scvmm, search, security, securityandcompliance, securitydevops, securityinsights, serialconsole, servicebus, servicefabric, servicefabricmesh, servicelinker, servicenetworking, signalrservice, softwareplan, solutions, sql, sqlvirtualmachine, standbypool, storage, storageactions, storagecache, storagemover, storagepool, storagesync, storsimple, streamanalytics, subscription, synapse, syntex, testbase, timeseriesinsights, types, videoanalyzer, videoindexer, virtualmachineimages, visualstudio, vmwarecloudsimple, voiceservices, web, webpubsub, windowsesu, windowsiot, workloads, };
