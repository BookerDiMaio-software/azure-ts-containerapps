 ...
 * Gets draft package path and temp working path with SAS.
 */
export declare function getDraftPackagePathOutput(args: GetDraftPackagePathOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDraftPackagePathResult>;
