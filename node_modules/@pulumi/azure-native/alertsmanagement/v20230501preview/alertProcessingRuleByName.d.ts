...
export declare class AlertProcessingRuleByName extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.alertsmanagement.v20230501preview.AlertProcessingRulePropertiesResponse>;
    /**
     * Alert processing rule system data.
     */
    readonly systemData: pulumi.Output<outputs.alertsmanagement.v20230501preview.SystemDataResponse>;
    /**
     * Resource tags
     */
