...
export interface ListApplianceClusterCustomerUserCredentialResult {
     ...
     */
    readonly sshKeys: {
        [key: string]: outputs.resourceconnector.v20220415preview.SSHKeyResponse;
    };
}
/**
 * Returns the cluster customer user credentials for the dedicated appliance.
 */
export declare function listApplianceClusterCustomerUserCredentialOutput(args: ListApplianceClusterCustomerUserCredentialOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListApplianceClusterCustomerUserCredentialResult>;
