...
export interface GetClusterManagerResult {
     ...
     */
    readonly clusterVersions: outputs.networkcloud.v20230501preview.ClusterAvailableVersionResponse[];
    /**
     ...
     */
    readonly managerExtendedLocation: outputs.networkcloud.v20230501preview.ExtendedLocationResponse;
    /**
 ...
 * Get the properties of the provided cluster manager.
 */
export declare function getClusterManagerOutput(args: GetClusterManagerOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetClusterManagerResult>;
