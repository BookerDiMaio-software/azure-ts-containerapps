...
export interface GetCloudServicesNetworkResult {
     ...
     */
    readonly additionalEgressEndpoints?: outputs.networkcloud.v20230501preview.EgressEndpointResponse[];
    /**
     ...
     */
    readonly enabledEgressEndpoints: outputs.networkcloud.v20230501preview.EgressEndpointResponse[];
    /**
 ...
 * Get properties of the provided cloud services network.
 */
export declare function getCloudServicesNetworkOutput(args: GetCloudServicesNetworkOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCloudServicesNetworkResult>;
